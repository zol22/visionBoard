    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {props.searchResults.map((result) => (
                <div
                    key={result.id}
                    className="relative group cursor-pointer overflow-hidden rounded-lg shadow-md h-[300px] bg-gray-200" // Set background color to gray or any preferred color
                ...
                >
                    <img
                        ...
                        className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105" // Ensure the image fits the container
                    />
